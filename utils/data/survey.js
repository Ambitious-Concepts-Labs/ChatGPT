export const survey = [
  {
    ...
    "answerOptions": [
      ...
      { "answer": "It helps, but I could solve my problem just as easily without this app." },
      { "answer": "It helps, but I could solve my problem just as easily or easier with another app.", "isCorrect": true },
  ...
  },
  {
    ...
    "answerOptions": [
      ...
      { "answer": "It will take me a few uses to master the app.", "isCorrect": true },
      { "answer": "Next time I use it, I’ll know exactly what to do." },
      { "answer": "It felt like I’ve been using it all my life." }
    ]
  },
  {
    "question": "How much would you pay for this app with all of its features (full version)?",
    "answerOptions": [
      { "answer": "I wouldn’t pay for this app at all" },
      { "answer": "I would prefer to pay just for certain features of this app.", "isCorrect": true },
      { "answer": "$29/month" },
      { "answer": "$49/month" },
      { "answer": "$99/month" },
    ]
